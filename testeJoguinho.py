...
def load():
    ...
    #------------------------- aqui eu coloquei assim q tu falou na aula q tava dificil de ler tudo ----------------------------------------------------
    #mudkip
    mudkip = {"speed":0.1, "water":False, "idle":{"spriteSheet": pygame.image.load("spritesMons/mudkip/Mudkip-Idle-Anim.png"), "largura": 7, "altura": 8, "frameReset": 6, "animTime": 100 }, 
    ...
    #chimchar
    chimchar = {"speed":0.12, "water":True, "idle":{"spriteSheet": pygame.image.load("spritesMons/chimchar/Chimchar-Idle-Anim.png"), "largura": 5, "altura": 8, "frameReset": 4, "animTime": 100 }, 
                ...
                "strike":{"spriteSheet": pygame.image.load("spritesMons/chimchar/Chimchar-Strike-Anim.png"), "largura": 10, "altura": 8, "frameReset": 9, "animTime": 75 }, 
                "portrait": {"spriteSheet": pygame.image.load("spritesMons/chimchar/chimchar_portrait.png"), "largura": 5, "altura": 8},
                }
    
    #wigglytuff
    wiggly = {"idle":{"spriteSheet": pygame.image.load("spritesMons/wigglytuff/Wiggly-Idle-Anim.png"), "largura": 4, "altura": 8, "frameReset": 3, "animTime": 150 }, 
